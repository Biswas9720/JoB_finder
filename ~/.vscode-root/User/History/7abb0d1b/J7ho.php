			...
			<footer class="footer-wrapper">
					...
					<div class="container">
						...
						<div class="row">
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											<h5 class="footer-title">About Job-Finder</h5>
											<p>Job-Finder connects job seekers with tailored opportunities and employers with top talent through advanced matching and a user-friendly platform.</p>
							...
							<div class="col-sm-12 col-md-3 mt-30-sm">
								...
								<p>Email : <a href="sujanacharya531@gmail.com"></a>sujanacharya531@gmail.com</p>
								<p>Phone : <a href="tel:+233546607474">+977 9826189697</a></p>
				...
				<div class="bottom-footer">
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> BS2 Vision Software</p>
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> BS@ Vision Software</p>
